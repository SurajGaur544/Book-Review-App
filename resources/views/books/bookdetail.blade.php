            ...
            <div class="col-md-12">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-4">
                            ...
                            @if($book->image != '')
                                <img src="{{ asset('uploads/books/'.$book->image) }}" style="width: 990; height:1400"  alt="Loading..." class="card-img-top">
                            @else
                                <img src="https://placehold.co/990x1400?text=No Image"  alt="Loading..." class="card-img-top">
                            @endif
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-4 col-lg-4 mb-4">
                                <div class="card border-0 shadow-lg">
                                    <a href="{{ route('books.detail',$relatedBook->id) }}">
            ...
            <div class="modal-content">
                ...
                <form action="" id="bookReviewForm" name="bookReviewForm">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" id="bookReviewForm" class="btn btn-primary">Submit</button>
                    </div>
                </form>
            </div>
        </div>
